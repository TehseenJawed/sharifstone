...
const ViewCollection = () => {
  ...
  const updateCollection = async (id) => {
    ...
    await axios.put(`http://localhost:3005/api/collection/${id}`,editFields)
    .then((response) => {
  ...
  const deleteCollection = async (id) => {
    console.log(id, editFields);
    await axios.delete(`http://localhost:3005/api/collection/${id}`)
    .then((response) => {
                      ...
                      <div className="collection-row">
                        ...
                        <div className="rowcell-2">
                          {edit === v?.id ? (
                            ...
                            <button onClick={() => setEdit(v.id)}>Edit</button>
                          )}
                        </div>
